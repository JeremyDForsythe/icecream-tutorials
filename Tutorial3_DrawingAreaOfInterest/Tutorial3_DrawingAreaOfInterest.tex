...
You do not need to submit this .zip shapefile. In a future tutorial, we will use this shapefile to make an A$\rho\rho$EEARS request and download ECOSTRESS data, so remember the folder where you save it. 
